...
class MoreVideoInfo : public Fl_Double_Window {
  void _MoreVideoInfo();
public:
  MoreVideoInfo(int X, int Y, int W, int H, const char *L = 0);
  MoreVideoInfo(int W, int H, const char *L = 0);
  MoreVideoInfo();
  Fl_Box *vm_thumbnail;
  Fl_Scroll *vm_scroll;
...
std::vector<video_metadata> metadata_list;
public:
  void delete_all_metadata();
